/*
g * Copyright (C) 2010 The Android Open Source Project
 *
...
public class ReplicaView extends SurfaceView implements SurfaceHolder.Callback {
	 ...
	 * {@link #setRenderer} to register a renderer.
	 */
	public ReplicaView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
	 ...
	 * this interface, and then call {@link ReplicaView#setRenderer} to register
	 * the renderer with the GLSurfaceView.
	 * <p>
	 * <h3>Threading</h3>
	 ...
	 * the {@link ReplicaView#queueEvent(Runnable)} convenience method.
	 * <p>
	 ...
	 * {@link ReplicaView#setEGLContextFactory(EGLContextFactory)}
	 */
	 ...
	 * <p>
	 * This interface must be implemented by clients wishing to call
	 * {@link ReplicaView#setEGLWindowSurfaceFactory(EGLWindowSurfaceFactory)}
	 */
	 ...
	 * <p>
	 * This interface must be implemented by clients wishing to call
	 * {@link ReplicaView#setEGLConfigChooser(EGLConfigChooser)}
	 */
	...
	private class EglHelper {
		...
		public boolean verifyContext() {
			...
			Log.d("ReplicaView","verifyContext:"
					+ (currentContext == EGL10.EGL_NO_CONTEXT) + ":"
	...
	private class GLThread extends Thread {
		 ...
		 */
		private void stopEglLocked(boolean destroy) {
			if (mHaveEglSurface) {
				Log.d("ReplicaView","stop egl locked");
				...
				while (true) {
					...
					if (mHasFocus) {
						...
						if (!mEglHelper.swap()) {
							...
							Log.d("ReplicaView","swap failed");
							stopEglLocked(true);
						}
//						long limitFPS = (long) (BuildOpition.fpsLimited ? 1000f / BuildOpition.fps
//								: 16);
//						while (System.currentTimeMillis() - time < limitFPS) {
//
//						}
					}
