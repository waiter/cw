/************************************************************************
Button (can be add to BatchNode) v1.2.3
author: waiter
v1.0.1:
...
public:
	...
	//the default action rect is CCRectMake(0,0,width,height) , it has noting to do with AnchorPoint;
	inline void setActionRect(const cocos2d::CCRect& actionRect){
		p_actionRect = actionRect;
	};
